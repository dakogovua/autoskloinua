...
if(auth_user($username,$password))
{
	...
	echo "<html><head><link href=\"general.css\" rel=\"stylesheet\" type=\"text/css\"></head></body><center><table class=maintable border=0 cellspacing=4 cellpadding=4>
		  <tr>
   			 <td>
				<table border=0 cellspacing=0 cellpadding=2>
 					 <tr>
        				  <td class=title>Welcome $username </td>
  					</tr>
  					<tr>
  						  <td class=message align=center>What Do You Want To Do $username?<br><a href='?page=post'>Post News</a> | <a href='?page=edit'>Edit News</a> | <a href='realnews.php'>View News</a> | <a href='/'>Go Home</a> | <a href='login.php'>Logout</a></td>
					</tr>
  					<tr>
...
<table border=0 cellspacing=0 cellpadding=2>
  <tr>
          <td class=title>Sorry $username </td>
  </tr>
  <tr>
    <td class=message align=center>Either The Username ($username) or the Password ($password) that you submitted was incorrect.<br><a href='login.php'>Login</a></td>
  </tr>
  <tr>
          <td class=foot align=right>$adate</td>
  </tr></td>
...
if($page=="edit"){
	...
	echo "<center><br><table border=0 cellspacing=4 cellpadding=4>
	  <tr>
 	   <td class=maintable>
	<form name='loginuser' method='post' action=\"?page=edited&key=$key\"><input type='hidden' name='newdate' 
	value=\"$date\"><input type='hidden' name='newauthor' value=\"$author\"><table cellspacing='0' 
	cellpadding='2' border='0'>
	<tr>
	<td colspan=4 class=title>Edit News $username</td></tr>
	<tr>
	...
	value=$subject></td>
 	   ...
 	   <td class=message><textarea class=form name='newmessage' id=message cols=50 rows=10>$message</textarea> </td>
 	  </tr><tr>
	...
	<option value='images/avatars/1.gif'>1</option>
	<option value='images/avatars/100.gif'>100</option>
	<option value='images/avatars/102.gif'>102</option>
	<option value='images/avatars/103.gif'>103</option>
	<option value='images/avatars/110.gif'>110</option>
		</select></td>
		<td class=message align=center><img src=$image name='avatarpic' align='absmiddle' 
	...
	<tr><!-- Row 2 -->
	    <td class=title colspan=2>Post News $username</td></tr>
	<tr><!-- Row 2 -->
  	  <td class=message><form name='loginuser' method='post' action='?page=write'><b>Subject:</b></td>
	...
	<option value='images/avatars/110.gif'>110</option>
		...
		<td class=message align=center><img src='images/avatars/clear_avatar.gif' name='avatarpic' align='absmiddle' 
	...
	$entry = "$adate||$message||$username||$image||$subject||$count||0\n";
	$fp = fopen($file,'a'); 
	$fw = fwrite($fp,$entry);
	fclose($fp);
	echo "<center><br><table border=0 cellspacing=4 cellpadding=4>
	...
	<table width=400 border=0 cellspacing=0 cellpadding=2><tr>
 	 ...
 	 <tr>
 	         <td class='foot' align='right'>Posted by, $username on $adate</td>
 	 </tr>
 	 <tr>
			   <td height='4' background=''></td>
 	 </tr></table></td>
