...
class LiqPay
{
    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form method="POST" action="%s" accept-charset="utf-8" id="liqpay">
                %s
                %s
                <input type="image" src="//static.liqpay.ua/buttons/p1%s.radius.png" name="btn_text" type="submit"/ hidden>
            </form>
            <script>
